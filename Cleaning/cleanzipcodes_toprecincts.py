...
zipfile = pathlib.Path("cleanzipcodes_toprecincts.py").parent /"/Datasets/Shape Files/Chicagozipshape/geo_export_a5b7e796-fdb8-4ec5-9369-cbebeb1ef23f.shp"
zips= geopandas.read_file(zipfile)
overlap= geopandas.sjoin(precincts, zips)
trimmed_overlap = overlap[["ward","precinct","zip"]]
trimmed_overlap.to_csv("clean_zipcode_precinct.csv")
